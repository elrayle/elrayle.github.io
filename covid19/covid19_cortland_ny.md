...
<div id="covid19-graph">
    <p class="last-updated">Last updated: April 5, 2020  7:50pm ET</p>
    ...
    <div id="auto-width-display">
        <picture>
            <source srcset="graphs/2020-04-05_world-us-ny-cortland_confirmed_cases_graphs_narrow.png" media="(max-width: 1350px)" />
            <source srcset="graphs/2020-04-05_world-us-ny-cortland_confirmed_cases_graphs.png">
            <img src="graphs/2020-04-05_world-us-ny-cortland_confirmed_cases_graphs_narrow.png" alt="Graphs for World, US, NY, and Cortland County and surrounding counties" style="width:auto" />
        </picture>
    </div>
    <div id="wide-display">
        <img src="graphs/2020-04-05_world-us-ny-cortland_confirmed_cases_graphs.png" alt="Graphs for World, US, NY, and Cortland County and surrounding counties" />
    </div>
    <div id="narrow-display">
        <img src="graphs/2020-04-05_world-us-ny-cortland_confirmed_cases_graphs_narrow.png" alt="Graphs for World, US, NY, and Cortland County and surrounding counties" />
    </div>  
</div>
